\documentclass[UTF8,openany,AutoFakeBold,AutoFakeSlant,zihao=-4]{ctexbook}
...
\renewcommand\cftchapfont{\heiti\small} %黑体小四你妈
...
%\renewcommand\cftsecaftersnum{.} %一级目录号后加点你妈
