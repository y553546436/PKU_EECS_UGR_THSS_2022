...
\newcommand{\ccc}[1]{\hfill\begin{small}// \textrm{#1}\end{small}}
\newcommand{\Output}{p}
\newcommand{\pmfKey}{x}
...
\newtheorem{mytheorem}{\setcounter{corollary}{1}定理}
\newtheorem{mycorollary}{推论}[mytheorem]
...
\newcommand{\class}{测试群}
\newcommand{\classes}{测试群}

\newcommand{\job}{测试场景\xspace}
